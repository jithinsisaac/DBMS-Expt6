...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <a class="navbar-brand" href="index.html">DBMS Expt</a>
      <button
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-3"> 
          <?php          
              ...
              $dropdownColumnQuery = "SELECT column_name from information_schema.columns where table_schema='htmlform' and table_name='info'"; 
